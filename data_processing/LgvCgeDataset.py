...
class LgvCgeDataset(Dataset):
    def __init__(self, graph_dir, pattern_dir, labels_path, names_path):
        labels = []
        ...
        agreement_ratio = [1.0 for _ in range(len(self.labels))]
        self.agreement_ratio = torch.tensor(agreement_ratio)
    ...
    def __getitem__(self, idx):
        ...
        ratio = self.agreement_ratio[idx]

        return graph_feature, pattern_feature, label, ratio
