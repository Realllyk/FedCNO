...
do
    ...
    do
        ...
        do 
            python fed_main/Fed_LGV.py --vul $vul --noise_type sys_noise --noise_rate $noise_rate --epoch 25  --warm_up_epoch 30 --device "$device"  --random_noise --global_weight "$gw"  --lab_name abl_no_cons --model_type CBGRU 
        done 
        done
    done
done
